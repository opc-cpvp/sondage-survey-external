...
namespace ComplaintFormCore.Models.pa
{
    public partial class SurveyPAModelValidator : AbstractValidator<SurveyPAModel>
    {
        public SurveyPAModelValidator(SharedLocalizer _localizer)
        {
            ...
            RuleFor(x => x.WordingOfRequest).NotEmpty().When(x => x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.WordingOfRequest).Length(0, 5000).When(x => x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // MoreDetailsOfRequest (Page: page_details_description_of_concerns)
            RuleFor(x => x.MoreDetailsOfRequest).Length(0, 5000).When(x => x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // DateOfFinalAnswer (Page: page_details_description_of_concerns)
            RuleFor(x => x.DateOfFinalAnswer).NotEmpty().When(x => x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.DateOfFinalAnswer).Length(0, 5000).When(x => x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // DidNoRecordExistChoice (Page: page_details_description_of_concerns)
            RuleFor(x => x.DidNoRecordExistChoice).NotEmpty().When(x => x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.DidNoRecordExistChoice).Must(x => new List<string> { "yes", "no" }.Contains(x)).When(x => x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

            // PrivacyActSectionsApplied (Page: page_details_description_of_concerns)
            RuleFor(x => x.PrivacyActSectionsApplied).Length(0, 5000).When(x => x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // ItemsNotRecieved (Page: page_details_description_of_concerns)
            RuleFor(x => x.ItemsNotRecieved).Length(0, 5000).When(x => x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // InstitutionAgreedRequestOnInformalBasis (Page: page_details_description_of_concerns)
            RuleFor(x => x.InstitutionAgreedRequestOnInformalBasis).NotEmpty().When(x => x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.InstitutionAgreedRequestOnInformalBasis).Must(x => new List<string> { "yes", "no", "not_sure" }.Contains(x)).When(x => x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

            // SummarizeYourConcernsAndAnyStepsTaken (Page: page_details_description_of_concerns)
            RuleFor(x => x.SummarizeYourConcernsAndAnyStepsTaken).NotEmpty().When(x => (x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintCorrection","NatureOfComplaintCollection","NatureOfComplaintUseAndDisclosure","NatureOfComplaintRetentionAndDisposal","NatureOfComplaintOther"}).Any()) && (x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any())).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.SummarizeYourConcernsAndAnyStepsTaken).Length(0, 5000).When(x => (x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintCorrection","NatureOfComplaintCollection","NatureOfComplaintUseAndDisclosure","NatureOfComplaintRetentionAndDisposal","NatureOfComplaintOther"}).Any()) && (x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any())).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // SummarizeYourComplaintAndAnyStepsTaken (Page: page_details_description_of_concerns)
            RuleFor(x => x.SummarizeYourComplaintAndAnyStepsTaken).NotEmpty().When(x => (x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintCorrection","NatureOfComplaintCollection","NatureOfComplaintUseAndDisclosure","NatureOfComplaintRetentionAndDisposal","NatureOfComplaintOther"}).Any()) && (x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any())).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.SummarizeYourComplaintAndAnyStepsTaken).Length(0, 5000).When(x => (x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintCorrection","NatureOfComplaintCollection","NatureOfComplaintUseAndDisclosure","NatureOfComplaintRetentionAndDisposal","NatureOfComplaintOther"}).Any()) && (x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any())).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));
