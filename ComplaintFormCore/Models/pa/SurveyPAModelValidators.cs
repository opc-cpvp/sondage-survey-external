...
{
    public class SurveyPAModelValidator : AbstractValidator<SurveyPAModel>
    {
        public SurveyPAModelValidator(SharedLocalizer _localizer)
        {
            ...
            // IsEmployeeChoice (Page: page_details_description_of_concerns)
            RuleFor(x => x.IsEmployeeChoice).NotEmpty().WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.IsEmployeeChoice).Must(x => new List<string> { "general_public", "employee_government" }.Contains(x)).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

            // DateSentRequests (Page: page_details_description_of_concerns)
            RuleFor(x => x.DateSentRequests).NotEmpty().When(x => x.NatureOfComplaint.Intersect(new List<string>() { "NatureOfComplaintDelay", "NatureOfComplaintExtensionOfTime", "NatureOfComplaintDenialOfAccess", "NatureOfComplaintLanguage" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.DateSentRequests).Length(0, 5000).When(x => x.NatureOfComplaint.Intersect(new List<string>() { "NatureOfComplaintDelay", "NatureOfComplaintExtensionOfTime", "NatureOfComplaintDenialOfAccess", "NatureOfComplaintLanguage" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // WordingOfRequest (Page: page_details_description_of_concerns)
            RuleFor(x => x.WordingOfRequest).NotEmpty().When(x => true/* TODO: x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.WordingOfRequest).Length(0, 5000).When(x => true/* TODO: x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // MoreDetailsOfRequest (Page: page_details_description_of_concerns)
            RuleFor(x => x.MoreDetailsOfRequest).Length(0, 5000).When(x => true/* TODO: x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // DateOfFinalAnswer (Page: page_details_description_of_concerns)
            RuleFor(x => x.DateOfFinalAnswer).NotEmpty().When(x => true/* TODO: x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.DateOfFinalAnswer).Length(0, 5000).When(x => true/* TODO: x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // DidNoRecordExistChoice (Page: page_details_description_of_concerns)
            RuleFor(x => x.DidNoRecordExistChoice).NotEmpty().When(x => true/* TODO: x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.DidNoRecordExistChoice).Must(x => new List<string> { "yes", "no" }.Contains(x)).When(x => true/* TODO: x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()*/).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

            // PrivacyActSectionsApplied (Page: page_details_description_of_concerns)
            RuleFor(x => x.PrivacyActSectionsApplied).Length(0, 5000).When(x => true/* TODO: x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // ItemsNotRecieved (Page: page_details_description_of_concerns)
            RuleFor(x => x.ItemsNotRecieved).Length(0, 5000).When(x => true/* TODO: x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // InstitutionAgreedRequestOnInformalBasis (Page: page_details_description_of_concerns)
            RuleFor(x => x.InstitutionAgreedRequestOnInformalBasis).NotEmpty().When(x => true/* TODO: x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.InstitutionAgreedRequestOnInformalBasis).Must(x => new List<string> { "yes", "no", "not_sure" }.Contains(x)).When(x => true/* TODO: x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any()*/).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

            // SummarizeYourConcernsAndAnyStepsTaken (Page: page_details_description_of_concerns)
            RuleFor(x => x.SummarizeYourConcernsAndAnyStepsTaken).NotEmpty().When(x => true/* TODO: (x.NatureOfComplaint anyof ["NatureOfComplaintCorrection","NatureOfComplaintCollection","NatureOfComplaintUseAndDisclosure","NatureOfComplaintRetentionAndDisposal", "NatureOfComplaintOther"]) && (x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any())*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.SummarizeYourConcernsAndAnyStepsTaken).Length(0, 5000).When(x => true/* TODO: (x.NatureOfComplaint anyof ["NatureOfComplaintCorrection","NatureOfComplaintCollection","NatureOfComplaintUseAndDisclosure","NatureOfComplaintRetentionAndDisposal", "NatureOfComplaintOther"]) && (x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any())*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // SummarizeYourComplaintAndAnyStepsTaken (Page: page_details_description_of_concerns)
            RuleFor(x => x.SummarizeYourComplaintAndAnyStepsTaken).NotEmpty().When(x => true/* TODO: (x.NatureOfComplaint anyof ["NatureOfComplaintCorrection","NatureOfComplaintCollection","NatureOfComplaintUseAndDisclosure","NatureOfComplaintRetentionAndDisposal", "NatureOfComplaintOther"]) && (x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any())*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.SummarizeYourComplaintAndAnyStepsTaken).Length(0, 5000).When(x => true/* TODO: (x.NatureOfComplaint anyof ["NatureOfComplaintCorrection","NatureOfComplaintCollection","NatureOfComplaintUseAndDisclosure","NatureOfComplaintRetentionAndDisposal", "NatureOfComplaintOther"]) && (x.NatureOfComplaint.Intersect(new List<string>() {"NatureOfComplaintDelay","NatureOfComplaintExtensionOfTime","NatureOfComplaintDenialOfAccess","NatureOfComplaintLanguage"}).Any())*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));
            ...
            // Complainant_HaveYouSubmittedBeforeChoice (Page: page_Complainant_representative)
            ...
            RuleFor(x => x.Complainant_ProvinceOrState).NotEmpty().When(x => true/* TODO: x.Complainant_Country == "CA"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            ...
            RuleFor(x => x.Reprensentative_FormOfAddress).NotEmpty().When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.Reprensentative_FormOfAddress).Must(x => new List<string> { "Mr.", "Mrs.", "Ms.", "Other" }.Contains(x)).When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

            // Reprensentative_FirstName (Page: page_Complainant_representative)
            RuleFor(x => x.Reprensentative_FirstName).NotEmpty().When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.Reprensentative_FirstName).Length(0, 200).When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // Reprensentative_LastName (Page: page_Complainant_representative)
            RuleFor(x => x.Reprensentative_LastName).NotEmpty().When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.Reprensentative_LastName).Length(0, 200).When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // Reprensentative_Email (Page: page_Complainant_representative)
            RuleFor(x => x.Reprensentative_Email).NotEmpty().When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.Reprensentative_Email).Length(0, 200).When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));
            RuleFor(x => x.Reprensentative_Email).EmailAddress();

            // Reprensentative_MailingAddress (Page: page_Complainant_representative)
            RuleFor(x => x.Reprensentative_MailingAddress).NotEmpty().When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.Reprensentative_MailingAddress).Length(0, 200).When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // Reprensentative_City (Page: page_Complainant_representative)
            RuleFor(x => x.Reprensentative_City).NotEmpty().When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.Reprensentative_City).Length(0, 200).When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // Reprensentative_Country (Page: page_Complainant_representative)
            RuleFor(x => x.Reprensentative_Country).NotEmpty().When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));

            // Reprensentative_ProvinceOrState (Page: page_Complainant_representative)
            RuleFor(x => x.Reprensentative_ProvinceOrState).NotEmpty().When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else" && x.Reprensentative_Country == "CA"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));

            // Reprensentative_PostalCode (Page: page_Complainant_representative)
            RuleFor(x => x.Reprensentative_PostalCode).NotEmpty().When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.Reprensentative_PostalCode).Length(0, 200).When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // Reprensentative_DayTimeNumber (Page: page_Complainant_representative)
            RuleFor(x => x.Reprensentative_DayTimeNumber).NotEmpty().When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.Reprensentative_DayTimeNumber).Length(0, 200).When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // Reprensentative_DayTimeNumberExtension (Page: page_Complainant_representative)
            RuleFor(x => x.Reprensentative_DayTimeNumberExtension).Length(0, 200).When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // Reprensentative_AltTelephoneNumber (Page: page_Complainant_representative)
            RuleFor(x => x.Reprensentative_AltTelephoneNumber).Length(0, 200).When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // Reprensentative_AltTelephoneNumberExtension (Page: page_Complainant_representative)
            RuleFor(x => x.Reprensentative_AltTelephoneNumberExtension).Length(0, 200).When(x => true/* TODO: x.FilingComplaintOnOwnBehalf == "someone_else"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

            // NeedsDisabilityAccommodationChoice (Page: page_Complainant_representative)
            ...
            RuleFor(x => x.DisabilityAccommodation).NotEmpty().When(x => true/* TODO: x.NeedsDisabilityAccommodationChoice == "yes"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
            RuleFor(x => x.DisabilityAccommodation).Length(0, 5000).When(x => true/* TODO: x.NeedsDisabilityAccommodationChoice == "yes"*/).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));
