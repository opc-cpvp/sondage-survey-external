...
namespace ComplaintFormCore.Models
{
	public class SurveyPAModel
	{
		...
		/// Required condition: {NatureOfComplaintIsAnyFirstFourSelected} = true<br/>
		...
		/// Required condition: {NatureOfComplaintIsAnyFirstFourSelected} = true and {NatureOfComplaintIsAnyLastFiveSelected} = true<br/>
		/// Survey question type: comment
		/// </summary>
		...
		/// Required condition: {NatureOfComplaintIsAnyFirstFourSelected} = false and {NatureOfComplaintIsAnyLastFiveSelected} = true<br/>
		/// Survey question type: comment
		/// </summary>
		...
		/// Survey question type: dropdown
		/// </summary>
		public int? Reprensentative_ProvinceOrState { get; set; }
