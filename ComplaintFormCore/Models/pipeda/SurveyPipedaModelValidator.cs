...
{
	public partial class SurveyPipedaModelValidator : AbstractValidator<SurveyPipedaModel>
	{
		public SurveyPipedaModelValidator(SharedLocalizer _localizer)
		{
			...
			RuleFor(x => x.ComplaintAboutHandlingInformationOutsideProvince).NotEmpty().When(x => new List<int>() { x.ProvinceIncidence != null ? (int)x.ProvinceIncidence : 0 }.Intersect(new List<int>() { 2, 6, 9 }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.ComplaintAboutHandlingInformationOutsideProvince).Must(x => new List<string> { "yes", "no", "not_sure" }.Contains(x)).When(x => new List<int>() { x.ProvinceIncidence != null ? (int)x.ProvinceIncidence : 0 }.Intersect(new List<int>() { 2, 6, 9 }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

			// IsAgainstFwub (Page: page_part_a_jurisdiction_particulars)
			RuleFor(x => x.IsAgainstFwub).NotEmpty().When(x => new List<int>() { x.ProvinceIncidence != null ? (int)x.ProvinceIncidence : 0 }.Intersect(new List<int>() { 2, 6, 9 }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.IsAgainstFwub).Must(x => new List<string> { "yes", "no" }.Contains(x)).When(x => new List<int>() { x.ProvinceIncidence != null ? (int)x.ProvinceIncidence : 0 }.Intersect(new List<int>() { 2, 6, 9 }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

			// DidOrganizationDirectComplaintToOpc (Page: page_part_a_jurisdiction_particulars)
			RuleFor(x => x.DidOrganizationDirectComplaintToOpc).NotEmpty().When(x => new List<int>() { x.ProvinceIncidence != null ? (int)x.ProvinceIncidence : 0 }.Intersect(new List<int>() { 2, 6, 9 }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.DidOrganizationDirectComplaintToOpc).Must(x => new List<string> { "yes", "no" }.Contains(x)).When(x => new List<int>() { x.ProvinceIncidence != null ? (int)x.ProvinceIncidence : 0 }.Intersect(new List<int>() { 2, 6, 9 }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

			// ComplaintAgainstHandlingOfInformation (Page: page_part_a_jurisdiction_provincial)
			RuleFor(x => x.ComplaintAgainstHandlingOfInformation).NotEmpty().When(x => new List<int>() { x.ProvinceIncidence != null ? (int)x.ProvinceIncidence : 0 }.Intersect(new List<int>() { 1, 3, 4, 5, 7, 8, 10 }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.ComplaintAgainstHandlingOfInformation).Must(x => new List<string> { "yes", "no" }.Contains(x)).When(x => new List<int>() { x.ProvinceIncidence != null ? (int)x.ProvinceIncidence : 0 }.Intersect(new List<int>() { 1, 3, 4, 5, 7, 8, 10 }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

			// HealthPractitioner (Page: page_part_a_jurisdiction_provincial)
			RuleFor(x => x.HealthPractitioner).NotEmpty().When(x => new List<int>() { x.ProvinceIncidence != null ? (int)x.ProvinceIncidence : 0 }.Intersect(new List<int>() { 1, 3, 4, 5, 7, 8, 10 }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.HealthPractitioner).Must(x => new List<string> { "yes", "no" }.Contains(x)).When(x => new List<int>() { x.ProvinceIncidence != null ? (int)x.ProvinceIncidence : 0 }.Intersect(new List<int>() { 1, 3, 4, 5, 7, 8, 10 }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

			// IndependantPhysicalExam (Page: page_part_a_jurisdiction_provincial)
			RuleFor(x => x.IndependantPhysicalExam).NotEmpty().When(x => new List<int>() { x.ProvinceIncidence != null ? (int)x.ProvinceIncidence : 0 }.Intersect(new List<int>() { 1, 3, 4, 5, 7, 8, 10 }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.IndependantPhysicalExam).Must(x => new List<string> { "yes", "no", "not_applicable" }.Contains(x)).When(x => new List<int>() { x.ProvinceIncidence != null ? (int)x.ProvinceIncidence : 0 }.Intersect(new List<int>() { 1, 3, 4, 5, 7, 8, 10 }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));
			...
			RuleFor(x => x.EmployeeOrCustomer).Must(x => new List<string> { "customer", "employee", "other" }.Contains(x)).When(x => x.ProvinceIncidence <= 10).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

			// AgainstOrganizations (Page: page_part_a_customer_or_employee)
			RuleFor(x => x.AgainstOrganizations).NotEmpty().When(x => x.ProvinceIncidence <= 10 && new List<int>() { x.ProvinceIncidence != null ? (int)x.ProvinceIncidence : 0 }.Intersect(new List<int>() { 1, 3, 4, 5, 7, 8, 10 }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.AgainstOrganizations).Must(x => new List<string> { "yes", "no" }.Contains(x)).When(x => x.ProvinceIncidence <= 10 && new List<int>() { x.ProvinceIncidence != null ? (int)x.ProvinceIncidence : 0 }.Intersect(new List<int>() { 1, 3, 4, 5, 7, 8, 10 }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

			// Question3Answers (Page: page_part_a_competence)
			RuleForEach(x => x.Question3Answers).Must(x => new List<string> { "charity_non_profit", "condominium_corporation", "federal_government", "first_nation", "individual", "journalism", "political_party" }.Contains(x)).When(x => x.ProvinceIncidence <= 10).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));
			...
			RuleFor(x => x.DateAccessRequests).NotEmpty().When(x => new List<string>() { x.DeniedAccess }.Intersect(new List<string>() { "yes_and_other_concern", "yes" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.DateAccessRequests).Length(0, 5000).When(x => new List<string>() { x.DeniedAccess }.Intersect(new List<string>() { "yes_and_other_concern", "yes" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// AddressesAccessRequest (Page: page_part_c_details_complaint)
			RuleFor(x => x.AddressesAccessRequest).NotEmpty().When(x => new List<string>() { x.DeniedAccess }.Intersect(new List<string>() { "yes_and_other_concern", "yes" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.AddressesAccessRequest).Length(0, 5000).When(x => new List<string>() { x.DeniedAccess }.Intersect(new List<string>() { "yes_and_other_concern", "yes" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// ItemsNotReceived (Page: page_part_c_details_complaint)
			RuleFor(x => x.ItemsNotReceived).NotEmpty().When(x => new List<string>() { x.DeniedAccess }.Intersect(new List<string>() { "yes_and_other_concern", "yes" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.ItemsNotReceived).Length(0, 5000).When(x => new List<string>() { x.DeniedAccess }.Intersect(new List<string>() { "yes_and_other_concern", "yes" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));
			...
			RuleFor(x => x.Documentation_file_upload_rep).NotEmpty().When(x => x.FilingComplaintOnOwnBehalf == "someone_else" && new List<string>() { x.DocumentationType }.Intersect(new List<string>() { "upload", "both" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));

			// Documentation_file_upload (Page: page_part_c_documentation)
			RuleFor(x => x.Documentation_file_upload).NotEmpty().When(x => new List<string>() { x.DocumentationType }.Intersect(new List<string>() { "upload", "both" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
