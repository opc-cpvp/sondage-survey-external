...
namespace ComplaintFormCore.Models
{
	public partial class SurveyPIAToolModelValidator : AbstractValidator<SurveyPIAToolModel>
	{
		public SurveyPIAToolModelValidator(SharedLocalizer _localizer)
		{
			...
			RuleFor(x => x.UserEmailAddress16).EmailAddress().When(x => x.IsProgramInvolvePersonalInformation == false && x.ContactATIPQ16 == "receive_email");
			...
			RuleFor(x => x.UserEmailAddress18).EmailAddress().When(x => x.PersonalInfoUsedFor == "non_admin_purpose" && x.ContactATIPQ18 == "receive_email");
			...
			RuleFor(x => x.UserEmailAddress110).EmailAddress().When(x => x.SubjectOfPIA == "other" && x.ContactATIPQ110 == "receive_email");
			...
			RuleFor(x => x.BehalfSingleInstitution).NotEmpty().When(x => new List<string>() { x.SingleOrMultiInstitutionPIA }.Intersect(new List<string>() { "single", "single_related" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));

			// BehalfSingleInstitutionOther (Page: page_step_2_1_q_2_1_2a)
			RuleFor(x => x.BehalfSingleInstitutionOther).NotEmpty().When(x => new List<string>() { x.SingleOrMultiInstitutionPIA }.Intersect(new List<string>() { "single", "single_related" }).Any() && x.BehalfSingleInstitution == Institution.OTHER_INSTITUTION_ID).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.BehalfSingleInstitutionOther).Length(0, 200).When(x => new List<string>() { x.SingleOrMultiInstitutionPIA }.Intersect(new List<string>() { "single", "single_related" }).Any() && x.BehalfSingleInstitution == Institution.OTHER_INSTITUTION_ID).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));
			...
			RuleFor(x => x.BehalfMultipleInstitutionLeadOther).NotEmpty().When(x => x.SingleOrMultiInstitutionPIA == "multi" && x.BehalfMultipleInstitutionLead == Institution.OTHER_INSTITUTION_ID).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.BehalfMultipleInstitutionLeadOther).Length(0, 200).When(x => x.SingleOrMultiInstitutionPIA == "multi" && x.BehalfMultipleInstitutionLead == Institution.OTHER_INSTITUTION_ID).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));
			...
			RuleFor(x => x.AnotherContactEmail).EmailAddress().When(x => x.PersonContact == "another");
			...
			RuleFor(x => x.UserEmailAddress317).EmailAddress().When(x => x.ContactATIPQ317 == "receive_email");
			...
			RuleFor(x => x.ProcessHandlingPrivacyComplaintDescription).NotEmpty().When(x => new List<string>() { x.ProcessHandlingPrivacyComplaint }.Intersect(new List<string>() { "yes_in_place", "yes_not_established" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.ProcessHandlingPrivacyComplaintDescription).Length(0, 5000).When(x => new List<string>() { x.ProcessHandlingPrivacyComplaint }.Intersect(new List<string>() { "yes_in_place", "yes_not_established" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));
			...
			// PersonalInformationCategory (Page: page_step_3_3_2)
			...
			RuleFor(x => x.InformationPhysicalFormatDescription).NotEmpty().When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "physical", "both" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.InformationPhysicalFormatDescription).Length(0, 5000).When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "physical", "both" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// IsPhysicalConvertedToElectronic (Page: page_step_3_3_5)
			RuleFor(x => x.IsPhysicalConvertedToElectronic).NotEmpty().When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "physical", "both" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));

			// InformationPhysicalConvertedCopyDescription (Page: page_step_3_3_5)
			RuleFor(x => x.InformationPhysicalConvertedCopyDescription).NotEmpty().When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "physical", "both" }).Any() && x.IsPhysicalConvertedToElectronic == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.InformationPhysicalConvertedCopyDescription).Length(0, 5000).When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "physical", "both" }).Any() && x.IsPhysicalConvertedToElectronic == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// PersonalInformationElectronicFormatDescription (Page: page_step_3_3_6)
			RuleFor(x => x.PersonalInformationElectronicFormatDescription).NotEmpty().When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "electronic", "both" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.PersonalInformationElectronicFormatDescription).Length(0, 5000).When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "electronic", "both" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// IsElectronicConvertedToPhysical (Page: page_step_3_3_6)
			RuleFor(x => x.IsElectronicConvertedToPhysical).NotEmpty().When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "electronic", "both" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));

			// IsInformationElectronicConvertedCopyDescription (Page: page_step_3_3_6)
			RuleFor(x => x.IsInformationElectronicConvertedCopyDescription).NotEmpty().When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "electronic", "both" }).Any() && x.IsElectronicConvertedToPhysical == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.IsInformationElectronicConvertedCopyDescription).Length(0, 5000).When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "electronic", "both" }).Any() && x.IsElectronicConvertedToPhysical == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));
			...
			RuleFor(x => x.WhereWhomInfoCollectedOtherDetails).NotEmpty().When(x => x.WhereWhomInfoCollected.Contains("other")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.WhereWhomInfoCollectedOtherDetails).Length(0, 5000).When(x => x.WhereWhomInfoCollected.Contains("other")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// IsOriginalPurposeConsistent (Page: page_step_3_4_3_and_3_4_4)
			RuleFor(x => x.IsOriginalPurposeConsistent).NotEmpty().When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));

			// OriginalPurposeIsConsistentSummary (Page: page_step_3_4_3_and_3_4_4)
			RuleFor(x => x.OriginalPurposeIsConsistentSummary).NotEmpty().When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.OriginalPurposeIsConsistentSummary).Length(0, 5000).When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// OriginalPurposeIsNotConsistentJustification (Page: page_step_3_4_3_and_3_4_4)
			RuleFor(x => x.OriginalPurposeIsNotConsistentJustification).NotEmpty().When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.OriginalPurposeIsNotConsistentJustification).Length(0, 5000).When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// WhyCollectInfoOtherSource (Page: page_step_3_4_5)
			RuleFor(x => x.WhyCollectInfoOtherSource).NotEmpty().When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.WhyCollectInfoOtherSource).Length(0, 5000).When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// FormalInformationSharingAgreement (Page: page_step_3_4_6_A_and_C)
			RuleFor(x => x.FormalInformationSharingAgreement).NotEmpty().When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.FormalInformationSharingAgreement).Must(x => new List<string> { "yes_already_in_place", "yes_not_established", "no" }.Contains(x)).When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

			// ThirdPartyCollectionDescription (Page: page_step_3_4_6_A_and_C)
			RuleFor(x => x.ThirdPartyCollectionDescription).NotEmpty().When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.ThirdPartyCollectionDescription).Length(0, 5000).When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// DocumentationRelevantISA (Page: page_step_3_4_6B)
			RuleFor(x => x.DocumentationRelevantISA).NotEmpty().When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.DocumentationRelevantISA).Must(x => new List<string> { "upload", "link", "not_able" }.Contains(x)).When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

			// DocumentationRelevantISALinks (Page: page_step_3_4_6B)
			RuleFor(x => x.DocumentationRelevantISALinks).NotEmpty().When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));

			// DocumentationISAMissingExplanation (Page: page_step_3_4_6B)
			RuleFor(x => x.DocumentationISAMissingExplanation).NotEmpty().When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.DocumentationISAMissingExplanation).Length(0, 5000).When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// ISAFiles (Page: page_step_3_4_6B)
			RuleFor(x => x.ISAFiles).NotEmpty().When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			...
			RuleFor(x => x.HasNewPIBWorkBegun).NotEmpty().When(x => x.HasExistingPIB == false && new List<string>() { x.NoPIBStatusReason }.Intersect(new List<string>() { "new_pib", "update_pib" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));

			// PIBStatusExplanationType (Page: page_step_3_4_10_a_b_c)
			RuleFor(x => x.PIBStatusExplanationType).NotEmpty().When(x => x.HasExistingPIB == false && new List<string>() { x.NoPIBStatusReason }.Intersect(new List<string>() { "new_pib", "update_pib" }).Any() && x.HasNewPIBWorkBegun == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.PIBStatusExplanationType).Must(x => new List<string> { "text_field", "upload" }.Contains(x)).When(x => x.HasExistingPIB == false && new List<string>() { x.NoPIBStatusReason }.Intersect(new List<string>() { "new_pib", "update_pib" }).Any() && x.HasNewPIBWorkBegun == true).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

			// PIBStatusExplanationText (Page: page_step_3_4_10_a_b_c)
			RuleFor(x => x.PIBStatusExplanationText).NotEmpty().When(x => x.HasExistingPIB == false && new List<string>() { x.NoPIBStatusReason }.Intersect(new List<string>() { "new_pib", "update_pib" }).Any() && x.HasNewPIBWorkBegun == true && x.PIBStatusExplanationType == "text_field").WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.PIBStatusExplanationText).Length(0, 5000).When(x => x.HasExistingPIB == false && new List<string>() { x.NoPIBStatusReason }.Intersect(new List<string>() { "new_pib", "update_pib" }).Any() && x.HasNewPIBWorkBegun == true && x.PIBStatusExplanationType == "text_field").WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// PIBFiles (Page: page_step_3_4_10_a_b_c)
			RuleFor(x => x.PIBFiles).NotEmpty().When(x => x.HasExistingPIB == false && new List<string>() { x.NoPIBStatusReason }.Intersect(new List<string>() { "new_pib", "update_pib" }).Any() && x.HasNewPIBWorkBegun == true && x.PIBStatusExplanationType == "upload").WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));

			// NoBeganPIBStatusExplanationText (Page: page_step_3_4_10_a_b_c)
			RuleFor(x => x.NoBeganPIBStatusExplanationText).NotEmpty().When(x => x.HasExistingPIB == false && new List<string>() { x.NoPIBStatusReason }.Intersect(new List<string>() { "new_pib", "update_pib" }).Any() && x.HasNewPIBWorkBegun == false).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.NoBeganPIBStatusExplanationText).Length(0, 5000).When(x => x.HasExistingPIB == false && new List<string>() { x.NoPIBStatusReason }.Intersect(new List<string>() { "new_pib", "update_pib" }).Any() && x.HasNewPIBWorkBegun == false).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// WhyNoPlanToReflectNewConsistentPIB (Page: page_step_3_4_10_d_e)
			RuleFor(x => x.WhyNoPlanToReflectNewConsistentPIB).NotEmpty().When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.WhyNoPlanToReflectNewConsistentPIB).Length(0, 5000).When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// WhyNoPIBExplanation (Page: page_step_3_4_10_d_e)
			RuleFor(x => x.WhyNoPIBExplanation).NotEmpty().When(x => x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.WhyNoPIBExplanation).Length(0, 5000).When(x => x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// InstitutionNotifyIndividuals (Page: page_step_3_4_11)
			RuleFor(x => x.InstitutionNotifyIndividuals).NotEmpty().When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.InstitutionNotifyIndividuals).Must(x => new List<string> { "yes_already_in_place", "yes_not_established", "no" }.Contains(x)).When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));
			...
			RuleFor(x => x.InstitutionNotifyIndividualsDescription).NotEmpty().When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.InstitutionNotifyIndividualsDescription).Length(0, 5000).When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// NotificationTime (Page: page_step_3_4_12_and_13)
			RuleFor(x => x.NotificationTime).NotEmpty().When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.NotificationTime).Must(x => new List<string> { "before", "at", "after" }.Contains(x)).When(x => x.WhereWhomInfoCollected.Count == 1 && x.WhereWhomInfoCollected.Contains("directly")).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));
			...
			RuleFor(x => x.HowLongRetainPersonalInformationInPhysicalFormat).NotEmpty().When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "physical", "both" }).Any() || x.IsElectronicConvertedToPhysical == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.HowLongRetainPersonalInformationInPhysicalFormat).Length(0, 5000).When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "physical", "both" }).Any() || x.IsElectronicConvertedToPhysical == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// HowLongRetainPersonalInformationInElectronicFormat (Page: page_step_3_5_3)
			RuleFor(x => x.HowLongRetainPersonalInformationInElectronicFormat).NotEmpty().When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "electronic", "both" }).Any() || x.IsPhysicalConvertedToElectronic == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.HowLongRetainPersonalInformationInElectronicFormat).Length(0, 5000).When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "electronic", "both" }).Any() || x.IsPhysicalConvertedToElectronic == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));
			...
			RuleFor(x => x.ControlsProceduresImplementationDescription).NotEmpty().When(x => new List<string>() { x.ControlsProceduresImplementation }.Intersect(new List<string>() { "yes_in_place", "yes_not_established" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.ControlsProceduresImplementationDescription).Length(0, 5000).When(x => new List<string>() { x.ControlsProceduresImplementation }.Intersect(new List<string>() { "yes_in_place", "yes_not_established" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));
			...
			RuleFor(x => x.MechanismToCorrectPersonalInformationDescription).NotEmpty().When(x => new List<string>() { x.MechanismToCorrectPersonalInformation }.Intersect(new List<string>() { "yes_in_place", "yes_not_established" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.MechanismToCorrectPersonalInformationDescription).Length(0, 5000).When(x => new List<string>() { x.MechanismToCorrectPersonalInformation }.Intersect(new List<string>() { "yes_in_place", "yes_not_established" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));

			// WillProvideOpportunityToAddStatement (Page: page_step_3_6_1_b_c)
			RuleFor(x => x.WillProvideOpportunityToAddStatement).NotEmpty().When(x => new List<string>() { x.MechanismToCorrectPersonalInformation }.Intersect(new List<string>() { "yes_in_place", "yes_not_established" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.WillProvideOpportunityToAddStatement).Must(x => new List<string> { "yes_in_place", "yes_not_established", "no" }.Contains(x)).When(x => new List<string>() { x.MechanismToCorrectPersonalInformation }.Intersect(new List<string>() { "yes_in_place", "yes_not_established" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

			// NotProvideOpportunityToAddStatementExplanation (Page: page_step_3_6_1_b_c)
			RuleFor(x => x.NotProvideOpportunityToAddStatementExplanation).NotEmpty().When(x => new List<string>() { x.MechanismToCorrectPersonalInformation }.Intersect(new List<string>() { "yes_in_place", "yes_not_established" }).Any() && x.WillProvideOpportunityToAddStatement == "no").WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.NotProvideOpportunityToAddStatementExplanation).Length(0, 5000).When(x => new List<string>() { x.MechanismToCorrectPersonalInformation }.Intersect(new List<string>() { "yes_in_place", "yes_not_established" }).Any() && x.WillProvideOpportunityToAddStatement == "no").WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));
			...
			RuleFor(x => x.CollectInformationAuthoritativeSourcesExplanation).NotEmpty().When(x => new List<string>() { x.IsCollectInformationAuthoritativeSources }.Intersect(new List<string>() { "yes_in_all_collection", "yes_but_not_in_all_collection" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.CollectInformationAuthoritativeSourcesExplanation).Length(0, 5000).When(x => new List<string>() { x.IsCollectInformationAuthoritativeSources }.Intersect(new List<string>() { "yes_in_all_collection", "yes_but_not_in_all_collection" }).Any()).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));
			...
			RuleFor(x => x.ProcessDisposalDocumentationPhysicalFormat).NotEmpty().When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "physical", "both" }).Any() || x.IsElectronicConvertedToPhysical == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			...
			RuleFor(x => x.ProcessDisposalElectronicFormat).NotEmpty().When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "electronic", "both" }).Any() || x.IsPhysicalConvertedToElectronic == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			...
			RuleFor(x => x.ProcessDisposalDocumentationElectronicFormat).NotEmpty().When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "electronic", "both" }).Any() || x.IsPhysicalConvertedToElectronic == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			...
			RuleFor(x => x.DisposalElectronicFormatDescription).NotEmpty().When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "electronic", "both" }).Any() || x.IsPhysicalConvertedToElectronic == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.DisposalElectronicFormatDescription).Length(0, 5000).When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "electronic", "both" }).Any() || x.IsPhysicalConvertedToElectronic == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsOverCharacterLimit"));
			...
			RuleFor(x => x.OtherPartiesSharePersonalInformation).NotEmpty().When(x => x.IsCollectionReasonOtherThanStorage == true && x.PartiesSharePersonalInformation.Count == 1 && x.PartiesSharePersonalInformation[0].Party == "other").WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));

			// PartiesSharePersonalInformation (Page: page_step_3_9_3B)
			RuleFor(x => x.PartiesSharePersonalInformation).NotEmpty().When(x => x.IsCollectionReasonOtherThanStorage == true && (x.PartiesSharePersonalInformation.Count == 1 && x.PartiesSharePersonalInformation[0].Party != "other" || x.PartiesSharePersonalInformation.Count > 1)).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));

			// WillAllPICollectedBeDisclosed (Page: page_step_3_9_4)

			// PersonalInformationCategory (Page: page_step_3_9_5A)
			RuleFor(x => x.PersonalInformationCategory).NotEmpty().When(x => x.IsCollectionReasonOtherThanStorage == true && x.PartiesSharePersonalInformation.Count == 1 && x.PartiesSharePersonalInformation[0].Party == "other" && x.WillAllPICollectedBeDisclosed == false).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));

			// OtherPartiesSharePersonalInformation (Page: page_step_3_9_5B)
			RuleFor(x => x.OtherPartiesSharePersonalInformation).NotEmpty().When(x => x.IsCollectionReasonOtherThanStorage == true && x.PartiesSharePersonalInformation.Count == 1 && x.PartiesSharePersonalInformation[0].Party == "other" && x.WillAllPICollectedBeDisclosed == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			...
			// PartiesSharePersonalInformation (Page: page_step_3_9_6C)
			RuleFor(x => x.PartiesSharePersonalInformation).NotEmpty().When(x => x.IsCollectionReasonOtherThanStorage == true && x.InformationSharingAgreementInPlace == "yes_in_place").WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			...
			RuleFor(x => x.IsPhysicalInfoStoredMultipleLocation).NotEmpty().When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "physical", "both" }).Any() || x.IsElectronicConvertedToPhysical == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));

			// IsElectronicInfoStoredMultipleLocation (Page: page_step_3_10_6)
			RuleFor(x => x.IsElectronicInfoStoredMultipleLocation).NotEmpty().When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "electronic", "both" }).Any() || x.IsPhysicalConvertedToElectronic == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));

			// StorageManagement (Page: page_step_3_10_7)
			RuleFor(x => x.StorageManagement).NotEmpty().When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "electronic", "both" }).Any() || x.IsPhysicalConvertedToElectronic == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			RuleFor(x => x.StorageManagement).Must(x => new List<string> { "all", "some", "none" }.Contains(x)).When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "electronic", "both" }).Any() || x.IsPhysicalConvertedToElectronic == true).WithMessage(_localizer.GetLocalizedStringSharedResource("SelectedValueNotValid"));

			// IsInstituionManageStorageOfPI (Page: page_step_3_10_7)
			RuleFor(x => x.IsInstituionManageStorageOfPI).NotEmpty().When(x => new List<string>() { x.PersonalInformationPhysicalAndOrElectronicFormat }.Intersect(new List<string>() { "electronic", "both" }).Any() || x.IsPhysicalConvertedToElectronic == true).WithMessage(_localizer.GetLocalizedStringSharedResource("FieldIsRequired"));
			...
			// IsStoredUsingCloudService (Page: page_step_3_10_10)
			...
			RuleForEach(x => x.BehalfMultipleInstitutionOthers).ChildRules(child => {
				// OtherInstitutionHeadTitle (Page: page_step_2_1_q_2_1_6)
			...
			RuleForEach(x => x.BehalfMultipleInstitutionOthers).ChildRules(child => {
				// OtherInstitutionSection (Page: page_step_2_1_q_2_1_6)
			...
			RuleForEach(x => x.BehalfMultipleInstitutionOthers).ChildRules(child => {
				// OtherInstitutionEmail (Page: page_step_2_1_q_2_1_6)
			...
			RuleForEach(x => x.BehalfMultipleInstitutionOthers).ChildRules(child => {
				// SeniorOfficialOtherFullname (Page: page_step_2_1_q_2_1_8)
			...
			RuleForEach(x => x.BehalfMultipleInstitutionOthers).ChildRules(child => {
				// SeniorOfficialOtherTitle (Page: page_step_2_1_q_2_1_8)
			...
			RuleForEach(x => x.BehalfMultipleInstitutionOthers).ChildRules(child => {
				// SeniorOfficialOtherSection (Page: page_step_2_1_q_2_1_8)
			...
			RuleForEach(x => x.BehalfMultipleInstitutionOthers).ChildRules(child => {
				// SeniorOfficialOtherEmail (Page: page_step_2_1_q_2_1_8)
			...
			RuleForEach(x => x.SecurityAssessment).ChildRules(child => {
				// SummaryFiles (Page: page_step_3_10_4_A_B)
