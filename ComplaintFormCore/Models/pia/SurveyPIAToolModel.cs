...
namespace ComplaintFormCore.Models
{
	public class SurveyPIAToolModel
	{
		...
		/// </summary>
		public int? BehalfSingleInstitution { get; set; }
		...
		/// Survey question type: dropdown
		/// </summary>
		public int? BehalfMultipleInstitutionLead { get; set; }
		...
		/// Required condition: {IsDirectlyFromIndividual} = true or {WhereWhomInfoCollected} != ['directly'] or ({WhereWhomInfoCollected} = ['directly'] and  {IsOriginalPurposeConsistent} = false)<br/>
		/// Survey question type: comment
		/// </summary>
		...
		/// Required condition: {IsPhysicalFormat} = true and {IsPhysicalInfoStoredMultipleLocation} = true or {IsElectronicFormat} = true and {IsElectronicInfoStoredMultipleLocation} = true<br/>
		/// Survey question type: radiogroup
		/// </summary>
		...
		/// Required condition: {IsPhysicalFormat} = true and {IsPhysicalInfoStoredMultipleLocation} = false or {IsElectronicFormat} = true and {IsElectronicInfoStoredMultipleLocation} = false<br/>
		/// Survey question type: boolean
		/// </summary>
