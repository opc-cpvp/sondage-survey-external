var widget = {
   ...
   // htmlTemplate: "<div id='cwd_main_div'><p id='cwd_title' class='sv_q_title'><span id='cwd_req_span' class='sv_q_required_text'></span></p><p id='cwd_description'></p><p><textarea class='sv_textarea'></textarea></p></div>",
    //The main function, rendering and two-way binding
    afterRender: function (question, el) {
        //el is our root element in htmlTemplate, is "div" in our case get the text element
        ...
        //var title = $(el).children("#cwd_main_div");
        //title[0].innerHTML = question.title;

        //var span_required = $(el).children("#cwd_req_span");

        //if (question.isRequired == true) {
        //    span_required[0].innerHTML = "(required)";
        //}

        //var htlmdescription = $(el).children("#cwd_description");
        //htlmdescription[0].innerHTML = question.htmldescription;
