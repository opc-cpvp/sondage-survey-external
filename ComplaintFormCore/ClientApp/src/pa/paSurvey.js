...
exports.PaSurvey = void 0;
var survey_vue_1 = require("survey-vue");
var survey_1 = require("../survey");
var checkboxwidget_1 = require("../widgets/checkboxwidget");
var filemeterwidget_1 = require("../widgets/filemeterwidget");
var PaSurvey = /** @class */ (function (_super) {
    __extends(PaSurvey, _super);
    function PaSurvey(locale, authToken, storageName) {
    ...
    PaSurvey.prototype.registerWidgets = function () {
        checkboxwidget_1.CheckboxWidget.register();
        filemeterwidget_1.FileMeterWidget.register();
    };
    PaSurvey.prototype.registerEventHandlers = function () {
        var _this = this;
    ...
    PaSurvey.prototype.handleOnServerValidateQuestions = function (sender, options) {
        var _this = this;
        if (!this.survey.isLastPage) {
            options.complete();
            return;
        }
        var validationUrl = "/api/PASurvey/Validate?complaintId=" + this.authToken;
    ...
    PaSurvey.prototype.handleOnComplete = function (sender, options) {
        var _this = this;
        void (function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        completeUrl = "/api/PASurvey/Complete?complaintId=" + this.authToken;
    ...
    PaSurvey.prototype.handleOnUploadFiles = function (sender, options) {
        var _this = this;
        void (function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    PaSurvey.prototype.handleOnClearFiles = function (sender, options) {
        options.callback("success");
    };
    return PaSurvey;
}(survey_1.SurveyBase));
exports.PaSurvey = PaSurvey;
//# sourceMappingURL=paSurvey.js.map