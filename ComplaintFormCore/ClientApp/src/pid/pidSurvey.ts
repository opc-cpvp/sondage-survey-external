        ...
        void fetch(jsonUrl)
            ...
            .then(json => {
                ...
                _survey.onCompleting.add((sender, options) => {
                    ...
                    const uri = `/api/PIDSurvey/Validate?complaintId="${sender.complaintId as string}`;
                ...
                _survey.onCurrentPageChanged.add((sender, options) => {
                    SurveyLocalStorage.saveStateLocally(sender, SurveyLocalStorage.storageName_PID);
                });
                ...
                SurveyLocalStorage.loadStateLocally(_survey, SurveyLocalStorage.storageName_PID, JSON.stringify(defaultData));

                SurveyLocalStorage.saveStateLocally(_survey, SurveyLocalStorage.storageName_PID);
