...
exports.PidSurvey = void 0;
var survey_vue_1 = require("survey-vue");
var survey_1 = require("../survey");
var Survey = require("survey-vue");
var widgets = require("surveyjs-widgets");
var filemeterwidget_1 = require("../widgets/filemeterwidget");
var PidSurvey = /** @class */ (function (_super) {
    __extends(PidSurvey, _super);
    function PidSurvey(locale, authToken, storageName) {
        if (locale === void 0) { locale = "en"; }
        var _this = _super.call(this, locale, storageName) || this;
        _this.surveyData = "";
        _this.textBoxesMaxLength = 100;
    ...
    PidSurvey.prototype.registerWidgets = function () {
        widgets.jqueryuidatepicker(Survey);
        filemeterwidget_1.FileMeterWidget.register();
    };
    PidSurvey.prototype.registerEventHandlers = function () {
        var _this = this;
        ...
        this.survey.onAfterRenderQuestion.add(function (sender, options) {
            _this.handleAfterRenderQuestion(sender, options);
        });
    };
    PidSurvey.prototype.handleOnServerValidateQuestions = function (sender, options) {
        var _this = this;
        if (!this.survey.isLastPage) {
            options.complete();
            return;
        }
        var validationUrl = "/api/PIDSurvey/Validate?complaintId=" + this.authToken;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        Object.keys(problem_1.errors).forEach(function (q) {
                            ...
                            var question = _this.survey.getQuestionByName(q);
    ...
    PidSurvey.prototype.handleOnComplete = function (sender, options) {
        var _this = this;
        void (function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        completeUrl = "/api/PIDSurvey/Complete?complaintId=" + this.authToken;
    ...
    PidSurvey.prototype.handleOnUploadFiles = function (sender, options) {
        var _this = this;
        void (function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    PidSurvey.prototype.handleOnClearFiles = function (sender, options) {
        options.callback("success");
    };
    PidSurvey.prototype.handleAfterRenderQuestion = function (sender, options) {
        if (options.question.getType() === "text") {
            var textQuestion = options.question;
            textQuestion.maxLength = this.textBoxesMaxLength;
        }
    };
    return PidSurvey;
}(survey_1.SurveyBase));
exports.PidSurvey = PidSurvey;
//# sourceMappingURL=pidSurvey.js.map